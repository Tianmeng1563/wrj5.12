...
def load_all_data():
    ...
    return {
        "A":[32.2338, 118.7486],
        "B":[32.2350, 118.7500],
        "A_set":True,"B_set":True,"obstacles":[]
    }
...
default_states = {
    ...
    "safe_radius": 0.0002, "flight_running": False, "flight_paused": False,
    "current_wp_idx": 0, "flight_speed": 8.5, "flight_start_time": None,
    "flight_waypoints": [], "battery": 100.0, "total_distance": 0.0,
    "elapsed_distance": 0.0, "route_side": "auto"
}
